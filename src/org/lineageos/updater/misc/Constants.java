...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.kangos.build.version";
    public static final String PROP_DEVICE = "ro.kangos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.kangos.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "kangos.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "kangos.updater.uri";
